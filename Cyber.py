...
def logo_taekyung():
    try:
        os.system("xdg-open https://api.whatsapp.com/send?phone=085831439773")
        time.sleep(3)
        os.system("clear")
        print(f"""
...
\033[1;92m
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Author: By 𝘣𝘶𝘥𝘪𝘴𝘦𝘵𝘪𝘢𝘸𝘢n
whatsapp:085831439773
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
/ /_/ (__  )  __/ /     / /___/ /  / /_/ / /  / /    
\____/____/\___/_/     /_____/_/   \____/_/  /_/     
                                                     

\033[1;91m\033[1;41m\033[1;97m Author: By User_Eror\033[;0m\033[1;91m\033[1;92m
""")
...
def put():
    ...
    try:
        ...
        mengetik("\033[37m[\033[31m•\033[37m]\033[32m Contoh nomor\033[37m : \033[37m\033[33m852*****\033[33m")
